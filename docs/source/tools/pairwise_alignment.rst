...
.. table::
   ...
   |  function                                                   | returns                                        |
   +=============================================================+================================================+
   |  :func:`abutils.tl.local_alignment`                         | :class:`abutils.tl.LocalAlignment`             |
   +-------------------------------------------------------------+------------------------------------------------+
   |  :func:`abutils.tl.global_alignment`                        | :class:`abutils.tl.GlobalAlignment`            |
   +-------------------------------------------------------------+------------------------------------------------+
   |  :func:`abutils.tl.semiglobal_alignment`                    | :class:`abutils.tl.SemiGlobalAlignment`        |
   +-------------------------------------------------------------+------------------------------------------------+
