...
.. table::
   ...
   +==========+======================================+========================================+
   | Pandas   | :ref:`to_pandas() <to-pandas>`       | returns a Pandas DataFrame             |
   +          +--------------------------------------+----------------------------------------+
   |          | :ref:`from_pandas() <from-pandas>`   | returns a list of ``Sequence`` or      |
   |          |                                      | ``Pair`` objects                       |
   +----------+--------------------------------------+----------------------------------------+
   | Polars   | :ref:`to_polars() <to-polars>`       | returns a Polars DataFrame             |
   +          +--------------------------------------+----------------------------------------+
   |          | :ref:`from_polars() <from-polars>`   | returns a list of ``Sequence`` or      |
   |          |                                      | ``Pair`` objects                       |
   +----------+--------------------------------------+----------------------------------------+
